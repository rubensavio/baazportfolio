    ...
    >
      ...
      <main className="services-main">
        ...
        <div className="services-content-wrapper">
              ...
              <div className="service-cards-grid">
                {serviceData.services.map((service, index) => (
                  <div key={index} className="service-info-card">
                    ...
                    <p className="service-info-description">{service.description}</p>
                  </div>
                ))}
              </div>
            </>
          ...
          {serviceData.mobileHighlights && serviceData.mobileHighlights.length > 0 && (
            <div className="service-highlights">
              <h2 className="services-section-heading">Our mobile app highlights</h2>
              <div className="service-highlights-grid">
                {serviceData.mobileHighlights.map((item) => (
                  <article className="service-highlight-card" key={item.title}>
                    ...
                    <p className="service-highlight-description">{item.description}</p>
                  </article>
                ))}
              </div>
            </div>
          ...
          {serviceData.mobileWorkflow && serviceData.mobileWorkflow.length > 0 && (
          ...
          {serviceData.mobileWhyChoose && (
            <div className="service-why-choose">
              ...
              <p className="service-tech-intro">{serviceData.mobileWhyChoose.intro}</p>
          ...
          {serviceData.mobileOfferings && (
            <div className="service-offerings">
              ...
              <p className="service-tech-intro">{serviceData.mobileOfferings.intro}</p>
          ...
          {techDeepDives.length > 0 && (
            ...
            >
              <h2 id="services-deep-dives-heading" className="services-section-heading">
                Technology stacks we ship here
              </h2>
              <p className="services-deep-dives-lead">
                Step into focused capability pages aligned to teams, toolchain choices,
                and common integration patterns—from web runtimes through data, AI
                workloads, and cloud delivery.
              </p>
