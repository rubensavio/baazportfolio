# Baaz Lead Generation Strategy

---

## Current State

| Channel | Status | Lead Flow |
|---|---|---|
| **Website** | Live at baaz.pro, `/get-in-touch` form exists | Passive; no lead magnets, no gated content, no exit-intent |
| **LinkedIn** | Content plan created, posting starting | Zero systematic outreach; no Sales Navigator |
| **Outbound** | None | No cold email, no prospecting sequences |
| **Referrals** | Organic/ad-hoc from past clients | No formal program |
| **Paid Ads** | None | No LinkedIn Ads, no Google Ads |
| **Partnerships** | None | No channel/referral partners |
| **Social Listening** | None | No intent monitoring |

**Target:** 10–15 qualified discovery calls per month within 90 days.

---

## Ideal Customer Profile (ICP)

Before any outreach, define who you're targeting precisely.

### Primary ICP

| Attribute | Value |
|---|---|
| **Company size** | 20–500 employees (funded startups, scale-ups, mid-market) |
| **Revenue** | $2M–$100M ARR |
| **Geography** | US (primary), UK, UAE, India (enterprise) |
| **Industries** | FinTech, HealthTech, Retail/eCommerce, Manufacturing, Construction Tech, HR Tech |
| **Roles (decision makers)** | CTO, VP Engineering, CPO, Head of Product, CEO (at startups <50 people) |
| **Roles (influencers)** | Engineering Managers, Product Managers, Technical Architects |
| **Trigger events** | Just raised Series A/B, new CTO/CPO hired, job postings for 5+ engineers, legacy system complaints, "AI strategy" mentioned in earnings/blog |
| **Pain signals** | Slow shipping velocity, can't hire fast enough, legacy system bottlenecks, AI PoC stuck, need mobile app but no mobile team |

### Secondary ICP

| Attribute | Value |
|---|---|
| **Company size** | 500–5,000 (enterprise innovation teams) |
| **Roles** | Innovation Lead, Digital Transformation Head, CIO |
| **Trigger** | New digital initiative, vendor consolidation, legacy modernization mandate |
...
- "looking for a technical co-founder" (they need a build partner)
- "anyone know a good agency for"
...
### 1.2 Competitor Engagement Tracking

People engaging with competitor posts are showing active buying intent. Monitor engagement (likes, comments) on posts from:

| Competitor | Why |
|---|---|
| **ThoughtWorks** | Enterprise engineering services; their audience is your ICP |
| **10Pearls** | Similar size, similar services |
| **WillowTree** | Mobile + product engineering |
| **Fueled** | Mobile app agency |
| **BairesDev** | Staff augmentation (their frustrated clients may want product-focused work) |
| **Simform** | Direct competitor in India |
...
### 1.3 CTO/CPO/CEO New Hire Monitoring

New tech leaders reassess vendor relationships within their first 90 days. Use LinkedIn Sales Navigator alerts for:

- **Job change alerts** for CTO, VP Engineering, CPO, Head of Product roles at companies matching your ICP
- **Company growth alerts** for companies posting 5+ engineering job openings (they need capacity)
...
## Channel 2: LinkedIn Outbound (Sales Navigator)

### 2.1 Sales Navigator Setup

**Investment:** ~$100/month (Professional plan)
...
| **New in Role** | Title: CTO OR "VP Engineering"; Changed jobs: Past 90 days; Company headcount: 51–500 |

### 2.2 Connection Strategy

**Volume:** 20–30 connection requests per day (stay under LinkedIn limits)
...
| Day | Task | Time | Owner |
|---|---|---|---|
| **Monday** | Review Trigify alerts, respond to Tier 1 signals | 30 min | Chitresh |
| **Monday** | Send 25 connection requests from saved searches | 20 min | Chitresh |
| **Tuesday** | Follow up on accepted connections (Day 3–5 messages) | 20 min | Chitresh |
| **Wednesday** | Engage with 10 ICP posts (comment, not just like) | 30 min | Ruben |
| **Wednesday** | Review competitor engagement, connect with ICP profiles | 20 min | Chitresh |
| **Thursday** | Send Day 10–14 follow-ups | 15 min | Chitresh |
| **Friday** | Review new CTO/CPO hire alerts, send congrats notes | 15 min | Chitresh |
| **Friday** | Send breakup messages (Day 21) | 10 min | Chitresh |

**Total time:** ~3 hours/week across Chitresh and Ruben.

---

## Channel 3: Cold Email Outbound
...
### 3.2 Prospecting Lists (Apollo.io)

Build lists matching the ICP:

| List | Apollo Filters | Expected Size |
|---|---|---|
| **US FinTech CTOs** | Title: CTO, VP Eng; Industry: Financial Services; Employees: 20–500; HQ: US; Funding: Seed–Series C | 500–1,000 |
| **US HealthTech Product** | Title: CPO, VP Product, Head of Product; Industry: Healthcare IT; Employees: 20–500; HQ: US | 300–500 |
| **Companies Hiring Engineers** | Job postings: "software engineer" (5+ open roles); Employees: 50–500; HQ: US, UK | 200–400 |
| **Series A/B Recently Funded** | Funding round: Series A, Series B; Date: last 90 days; Employees: 10–200; Industry: Software | 100–300 |
...
>
> If the timing isn't right, no worries at all. But if you ever need product engineering capacity, we're at baaz.pro.
>
...
> Hi [First Name],
>
> Just circling back. If you're currently evaluating engineering partners or thinking about bringing in external capacity for a specific initiative, I'd love a quick 15-min call.
>
...
| **Reply rate** | 3–8% (message quality + targeting) |
| **Positive reply rate** | 1–3% |
| **Meetings booked per 100 emails** | 1–3 |
| **Monthly send volume** | 500–1,000 (across all accounts) |
| **Bounce rate** | <2% (verify lists) |
| **Unsubscribe/spam** | <0.3% |

---

## Channel 4: Inbound Lead Capture (Website)

### 4.1 Lead Magnets (Gated Content)

Create 2–3 high-value downloadable assets that capture email addresses.
...
Current state: single `/get-in-touch` form. Add multiple entry points:

| CTA | Where | What Happens |
|---|---|---|
...
Once someone downloads a lead magnet, they enter a 3-email nurture sequence:
...
Past clients are the highest-conversion lead source. Formalize it.

### 5.1 Structure

| Element | Detail |
|---|---|
| **Who to ask** | Every client at project completion + quarterly check-in with past clients |
| **Incentive** | $500–$1,000 referral bonus for any introduction that converts to a signed project (paid after first milestone payment) |
| **How to ask** | Personal email from Chitresh, not a mass blast |
| **Tracking** | Simple spreadsheet: Referrer → Referred → Date → Status → Payout |

### 5.2 Referral Ask Template
...
> - Companies with a legacy system that needs modernizing
> - Teams that want to add AI but don't have ML engineers
>
> If anyone comes to mind, a warm intro would mean a lot. And we have a referral bonus ($X) for any intro that turns into a project.
>
...
Identify complementary service providers who serve the same ICP but don't compete:
...
**Action:** Identify 5 fractional CTOs on LinkedIn who advise startups. Connect, build relationship, offer a referral partnership.

---

## Channel 6: Content-to-Lead Funnel

### 6.1 Blog → Lead Magnet → Nurture → Call

The content strategy (from `visibility-plan-wiki-gbp-linkedin.md`) generates traffic. Convert that traffic:

```
Blog post (SEO/LinkedIn traffic)
    ↓
In-article CTA ("Want the framework as a template? Download it.")
    ↓
Lead magnet gate (email capture)
    ↓
...
### 6.2 LinkedIn Content → DM → Call

```
LinkedIn post (from Chitresh/Ruben)
    ↓
Engagement (comments, likes, shares)
    ↓
Profile visit (ICP checks your profile)
    ↓
Connect with engaged ICP profiles
    ↓
DM sequence (value-first)
    ↓
Discovery call
```

### 6.3 Guest Articles → Backlink + Bio CTA → Call
...
## Channel 7: Paid Channels (Month 2+, After Organic Foundation)

### 7.1 LinkedIn Ads (Retargeting First)
...
- CTA: "Book a Free Strategy Session" or promote a lead magnet
...
### 7.2 Google Ads (High-Intent Keywords Only)

Only bid on keywords where someone is actively looking for a service provider:

| Keyword | Intent | Est. CPC |
|---|---|---|
| "software development company" | High | $15–$30 |
| "mobile app development agency" | High | $10–$25 |
| "AI development company" | High | $10–$20 |
| "custom software development India" | High (geo) | $5–$15 |
| "hire flutter developers" | High | $8–$15 |
| "legacy modernization services" | High | $10–$20 |

**Landing pages:** Don't send to homepage. Create dedicated landing pages per service with one CTA (book a call).

**Budget:** $1,000–$2,000/month to start. Pause any keyword that doesn't convert within 30 days.

---

## Channel 8: Community & Event-Based Lead Gen

### 8.1 Online Communities

| Community | Action | Frequency |
|---|---|---|
| **Indie Hackers** | Answer questions about building products, share case studies | 2–3 posts/comments per week |
| **r/startups, r/SaaS, r/webdev** | Help people with technical architecture questions; link to blog when relevant | 2–3/week |
| **Hacker News** | Submit guest articles; comment on relevant threads | When articles publish |
| **Slack communities** (Rands Leadership, CTO Craft, Elpha) | Be helpful, not promotional. Build reputation over months. | Ongoing |
| **Product Hunt** | Launch a free tool or template (e.g., the MVP scoping template) | One-time |
...
## Channel 9: Intent Data & Signal-Based Selling

### 9.1 Job Posting Signals

Companies hiring engineers are either (a) growing fast or (b) can't hire fast enough. Both are opportunities.

**Tool:** Apollo.io job posting filter, or manually monitor on LinkedIn Jobs.
...
**Tool:** Crunchbase alerts (free tier) or PitchBook.

**When a company raises Series A/B:**
- They have capital and a mandate to build
- They typically evaluate agencies in the first 60 days post-raise
- Reach out within 2 weeks of the announcement

### 9.3 Tech Stack Signals

**Tool:** BuiltWith or Wappalyzer.
...
|---|---|---|---|
| 1 | Set up LinkedIn Sales Navigator; create 5 saved searches | Chitresh | Critical |
| 1 | Sign up for Trigify.io; configure keyword monitors (all 3 tiers) | Chitresh | Critical |
| 1 | Set up competitor engagement tracking in Trigify | Chitresh | Critical |
| 1 | Create CTO/CPO new-hire alerts in Sales Navigator | Chitresh | High |
| 2 | Purchase 2 secondary domains; set up Google Workspace + DNS | Ruben/Dev | High |
| 2 | Sign up for Instantly.ai; begin email warmup (2-week process) | Chitresh | High |
| 2 | Build first prospecting list in Apollo.io (500 contacts) | Chitresh | High |
| 2 | Draft and launch "Build vs. Buy Framework" lead magnet (PDF) | Chitresh + Ruben | High |
| 3 | Begin daily LinkedIn outbound (20–25 connections/day) | Chitresh | Critical |
| 3 | Start cold email Sequence 1 (after warmup complete) | Chitresh | High |
| 3 | Add Calendly "Book a Strategy Session" link to website | Dev | High |
| 3 | Install LinkedIn Insight Tag on baaz.pro | Dev | Medium |
| 4 | Send referral ask to top 5 past clients | Chitresh | High |
...
| Task | Owner |
|---|---|
| Continue daily LinkedIn outbound + social listening responses | Chitresh |
| Send cold email Sequence 2 (trigger-based, new CTO hires) | Chitresh |
| Launch "AI Readiness Assessment" lead magnet | Chitresh + Ruben |
| Add exit-intent popup to baaz.pro | Dev |
| Start LinkedIn retargeting ads ($500–$1,000 budget) | Chitresh |
| Begin engaging in 2–3 online communities (Indie Hackers, Reddit) | Ruben |
...
| Task | Owner |
|---|---|
| Launch "MVP Scoping Template" lead magnet + Product Hunt | Chitresh |
| Start Google Ads on 3–5 high-intent keywords ($1,000 budget) | Chitresh |
| Scale LinkedIn Ads to cold audience (if retargeting CPL is viable) | Chitresh |
| First guest podcast appearance | Chitresh or Ruben |
| First virtual webinar ("AI in Production" or "Idea to MVP") | Chitresh + Ruben |
| Apply to AWS Partner Network / Google Cloud Partner | Ruben |
| Formalize referral program with partner incentives | Chitresh |
| Review all channel ROI; double down on top 2 channels, cut underperformers | Both |

---

## Metrics & Pipeline Tracking

### Weekly Dashboard

| Metric | Source | Target (Month 1) | Target (Month 3) |
|---|---|---|---|
| **LinkedIn connections sent** | Sales Navigator | 100/week | 100/week |
| **LinkedIn connections accepted** | Sales Navigator | 25–30/week | 30–40/week |
| **LinkedIn DMs sent** | Manual | 15–20/week | 20–30/week |
| **Trigify intent signals found** | Trigify | 10–20/week | 20–40/week |
| **Cold emails sent** | Instantly.ai | 100–200/week | 300–500/week |
| **Email reply rate** | Instantly.ai | 3–5% | 5–8% |
| **Discovery calls booked** | Calendly | 3–5/month | 10–15/month |
| **Lead magnet downloads** | Website analytics | 10–20/month | 50–100/month |
| **Qualified opportunities** | CRM/spreadsheet | 2–3/month | 5–8/month |
| **Proposals sent** | Manual | 1–2/month | 4–6/month |

### Channel Attribution

Track where every lead comes from:

| Channel | Expected % of Pipeline |
|---|---|
| LinkedIn outbound (DMs + social listening) | 35–40% |
| Cold email | 20–25% |
| Referrals (clients + partners) | 15–20% |
| Inbound (website, lead magnets, SEO) | 10–15% |
| Paid (LinkedIn Ads, Google Ads) | 5–10% |
...
|---|---|---|
| Social listening | Trigify.io | ~$49–$149 |
| LinkedIn prospecting | LinkedIn Sales Navigator | ~$100 |
| Lead data | Apollo.io (free tier to start) | $0–$49 |
| Cold email sending + warmup | Instantly.ai | ~$30–$97 |
| Email verification | ZeroBounce or NeverBounce | ~$20 (pay-as-you-go) |
| Scheduling | Calendly (free tier) | $0 |
| CRM | HubSpot Free or a Google Sheet | $0 |
| Website analytics | Google Analytics 4 (already set up) | $0 |
| LinkedIn retargeting | LinkedIn Ads Manager | $500–$3,000 |
| Google Ads | Google Ads | $1,000–$2,000 |
| **Total (Month 1, no paid ads)** | | **~$200–$400** |
| **Total (Month 3, with paid ads)** | | **~$1,700–$5,400** |
...
3. **Multichannel.** The same prospect should see Baaz on LinkedIn (Chitresh/Ruben posts), in their inbox (if cold emailed), and on their retargeting ads. Frequency builds trust.
