...
export const thoughtworksAlternativesPost = {
  ...
  intro:
    "When you are seeking alternatives to ThoughtWorks, you tend to be a buyer who has a realistic budget and demands high-quality engineering. ThoughtWorks has established a reputation of agile transformation, disciplined delivery, and culture of strong technical. The cost, procurement friction, and models of engagement tradeoff are more suited to enterprise transformation than a twelve-week MVP sprint. Customers seldom contrast different logos with each other- they contrast archetypes: global integrators with huge benches, boutiques that prioritize craft, talent networks that speed hiring, regional product studios, and India-based delivery centres that combine cost efficiency with senior squads when properly vetted. This guide is a comparison of six popular directions, such as what each is supposed to do best, how engagements are typically organized (fixed phases, time-and-materials, retainers, augmentation), how to make a fair evaluation, and in which direction Baaz would fit when you need product engineering but not the full big-consultancy machine. It is authored to procurement, engineering leaders and founders, requiring defensible criteria, rather than some other hype list.",
  sections: [
    {
