...
export const howToScopeMvpThatShipsPost = {
  ...
  intro:
    "Most MVPs fail not because the code is bad but because scope grows until the entire roadmap fits in version one. Founders add must-haves, stakeholders demand parity features, and engineering inherits a six-month wish list disguised as a sprint. The fix is not another discipline slogan—it is an actual scoping contract: one actor, one job-to-be-done, one measurable outcome, and a definition of done a user can exercise in your absence. This guide walks through how to cut scope without cutting learning, write a brief your agency or team can estimate, and recognise when v2 features are being smuggled into v1. Baaz has shipped MVPs and platform slices for startups and enterprises since 2018; this is how we frame scope when a client insists they need everything and still has twelve weeks of runway.",
  sections: [
    {
      heading: "What Is an MVP For (and What Is It Not)?",
      body: [
        ...
        "Use the table below to separate prototypes, MVPs, and later releases—teams mix the labels constantly, and vocabulary drift causes scope arguments.",
      ],
      table: {
        caption:
          "How prototypes, MVPs, and post-MVP releases differ (buyer vocabulary)",
        headers: ["Artifact", "What it is for", "Typical audience / environment"],
        rows: [
          [
            "Prototype / spike",
            "Explore feasibility, align stakeholders, test UX flows cheaply",
            "Internal teams, usability sessions, investor demos—not always production-hardened",
          ],
          [
            "MVP",
            "Falsify or validate the riskiest assumption with the smallest shippable slice",
            "Real users on production-like infrastructure; metrics that reflect learning",
          ],
          [
            "Post-MVP / MMP",
            "Harden, extend, and scale after the core loop works",
            "Broader segments, SLAs, and operational readiness as volume grows",
          ],
        ],
      },
      references: [
        {
          label: "Wikipedia — Minimum viable product (definition & history)",
          href: "https://en.wikipedia.org/wiki/Minimum_viable_product",
        },
        {
          label: "Nielsen Norman Group — Usability testing overview",
          href: "https://www.nngroup.com/topic/usability-testing/",
        },
        {
          label: "OWASP — Top 10 Web Application Security Risks (baseline for shipping)",
          href: "https://owasp.org/www-project-top-ten/",
        },
      ],
    },
    {
      heading: "What Should You Prioritize First When Scoping an MVP?",
      body: [
    ...
    {
      heading: "What Is the Thin Vertical Slice Approach for MVPs?",
      body: [
        'Pick one persona and one job: "A billing admin connects Stripe and sees the first paid invoice in our UI." Trace the path end-to-end to cover every essential element:',
      ],
      items: [
        "Sign-up and authentication",
        "Permissioning and access control",
        "Core integration (e.g., Stripe, IdP, third-party API)",
        "Happy-path UI for the primary job",
        "Failure states that block money or data loss",
        "Enough logging and observability to debug in production",
      ],
      body2: [
    ...
    {
      heading: "How Do You Cut MVP Scope Without Losing the Product Story?",
      body: [
        "Scope cuts fail when they feel arbitrary. These four tactics keep the product story coherent while shrinking the build:",
      ],
      steps: [
        ...
        'Replace "no" with "phase two with metric." Example: "Search across all entities" becomes "phase two after we see how users navigate with filters on the primary entity." This ties cuts to learning, not opinion.',
    ...
    {
      heading: "What Should a One-Page MVP Brief Include?",
      body: [
    ...
    {
      heading: "Which Integrations and Compliance Requirements Eat Your MVP Calendar?",
      body: [
    ...
    {
      heading: "What Are the Warning Signs That v2 Features Are Creeping Into v1?",
      body: [
        "Watch for these four patterns — each one signals that scope has drifted beyond your riskiest assumption:",
      ],
      items: [
        'More than three "must-have" personas. Personas multiply scope faster than features.',
