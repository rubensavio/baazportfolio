...
export const technicalDueDiligenceCustomSoftwarePost = {
  ...
  intro:
    "Whether you are a founder raising a round, a corporate venture team supporting a build or a procurement group getting ready to renew a seven-figure statement of work, one clear cut question is, would the team we have in front of us fail tomorrow, would we still be able to execute and operate this product? The error is that diligence is being reduced to a code review beauty pageant. A brief list of verifiable facts makes up the win: repository and cloud access, IP assignment, dependency and secret hygiene, deployment path, on-call reality, and the existence of documentation in repos or the head of someone. This is a guide that takes you through what to ask, what good answers would look like and where buyers are caught unawares. It is the manner in which Baaz makes engineering artefacts ready to serious buyers, and how we counsel clients considering partners, without making diligence a months-long paper chase.",
  sections: [
    {
