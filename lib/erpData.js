...
export const erpData = {
  ...
  "manufacturing-companies": buildErpPage({
    ...
    metaTitle:
      "Custom ERP for Manufacturing India | MRP, Shop Floor & Costing | Baaz",
    metaDescription:
      "Custom ERP for manufacturing in India—MRP, BOM, shop-floor execution, QA, costing, and integrations from Baaz, Bangalore (ERP development company). Discrete and hybrid ERP software development services with phased rollout.",
    heroSubtitle:
  ...
  "healthcare-companies": buildErpPage({
    ...
    metaDescription:
      "Healthcare ERP software development—finance, supply chain, HR, compliance, integrations—aligned with clinical and revenue workflows. Bangalore-based Baaz architects phased programmes for hospitals and health networks.",
    heroSubtitle:
  ...
  "real-estate-companies": buildErpPage({
    ...
    metaTitle:
      "ERP for Real Estate Companies India | Developer & Portfolio | Baaz",
    metaDescription:
      "ERP for real estate developers and portfolio managers—project budgeting, WIP, leasing, tenant billing, procurement, dashboards. Custom ERP programmes and rollout support from Baaz Bangalore.",
    heroSubtitle:
  ...
  "construction-companies": buildErpPage({
    ...
    metaTitle:
      "ERP for Construction Companies India | WBS & Site Costing | Baaz",
    metaDescription:
      "ERP for construction and EPC in India—WBS, materials, subcontractors, retention, billing, cash flow, and controls. ERP software development and implementation guidance from Baaz, Bangalore.",
    heroSubtitle:
