...
export const erpData = {
  "insurance-companies": buildErpPage({
    ...
    metaTitle:
      "Insurance ERP - Claims, Premium & Compliance | Baaz",
    metaDescription:
  ...
  "manufacturing-companies": buildErpPage({
    ...
    metaTitle:
      "Manufacturing ERP - MRP, Shop Floor & Costing | Baaz",
    metaDescription:
  ...
  "banking-companies": buildErpPage({
    ...
    metaTitle:
      "Banking ERP - Procurement, GL Controls & Reporting | Baaz",
    metaDescription:
  ...
  hospitals: buildErpPage({
    ...
    metaTitle:
      "Hospital ERP - Pharmacy, Finance & Workforce | Baaz",
    metaDescription:
  ...
  "automobile-companies": buildErpPage({
    ...
    metaTitle:
      "Automotive ERP - BOM, Quality & Multi-Plant Planning | Baaz",
    metaDescription:
  ...
  "transportation-supply-chain-companies": buildErpPage({
    ...
    metaTitle:
      "Logistics ERP - Fleet, WMS & Freight Billing | Baaz",
    metaDescription:
  ...
  "education-training-companies": buildErpPage({
    ...
    metaTitle:
      "Education & Training ERP - Fees, CRM & Delivery | Baaz",
    metaDescription:
