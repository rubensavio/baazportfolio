import { HEALTHCARE_AI_EHR_SECTION } from "./healthcareAiEhrSection";
...
function buildErpPage({
  ...
  return {
    ...
    title,
    heroSubtitle,
    metaTitle: metaTitleOverride ?? `${title} | Baaz`,
    metaDescription:
    ...
    aiEhrSection: aiEhrSection ?? null,
  };
}
...
export const erpData = {
  "insurance-companies": buildErpPage({
    ...
    metaTitle:
      "Insurance ERP Implementation — Claims, Premium & Compliance | Baaz",
    metaDescription:
      "Insurance ERP implementation for carriers and MGAs: policy and premium accounting, claims FNOL-to-settlement, broker commissions, regulatory reporting, and audit-ready finance. Phased rollout with Baaz.",
    heroSubtitle:
    ...
    keyModules: [
      {
        ...
        description: "GL, AP/AR, premium accounting, commission management",
      },
      {
      ...
      {
        name: "Procurement",
        description: "Vendor onboarding, PO management, contract lifecycle",
      },
      {
        name: "HR & Payroll",
        description: "Employee records, payroll processing, leave management",
      },
      {
        name: "Compliance & Reporting",
        description: "Regulatory filings, audit trails, governance dashboards",
      },
      {
        name: "Document Management",
        description: "Policy documents, claim files, digital archival",
      },
    ],
    benefits: [
      {
  ...
  "manufacturing-companies": buildErpPage({
    ...
    metaTitle:
      "Manufacturing ERP — MRP, Shop Floor, Costing & Integrations | Baaz",
    metaDescription:
      "Manufacturing ERP: MRP/BOM-driven planning, shop-floor execution, QA, costing, procurement, maintenance, and integration patterns for discrete and hybrid plants. Practical rollout phases and risk reduction with Baaz.",
    heroSubtitle:
      "Integrated production planning, procurement, inventory, quality assurance, and cost control — built for plant-level precision.",
    editorialIntro: {
      heading:
        "Planning, shop-floor execution, costing, and integration—how it fits together",
      lead: "Beyond feature grids: how discrete and hybrid plants align MRP/BOM foundations, confirmations, QA evidence, costing, and plant integrations when operations never pause.",
    },
    editorialSections: [
      {
        title:
          "Why manufacturing ERP is different from generic back-office SaaS",
        paragraphs: [
          "Manufacturing runs on concurrency: procurement is placing blanket orders while production is reshaping batches, QA is dispositioning deviations, finance is arguing about standard versus actual margins, and customers are escalating ship dates—all at once. ERP for manufacturing is judged by whether it survives that concurrency without forcing teams back into spreadsheets for the exceptions that actually dictate profit and delivery.",
          "That is why BOM accuracy, routing consistency, substitution rules, and lot or serial genealogy are treated as foundational—not “nice extras” alongside GL and procurement. Plants that underestimate those foundations ship software that technically “goes live” yet fails whenever reality deviates from a happy-path demo.",
          "Industry-specific modelling also matters around batch versus discrete logic, rework and coproduct paths, tooling and fixture constraints, and variable yield. The goal is one operational truth spanning planning, execution, warehouse, QA, costing, compliance evidence, and customer commitments.",
        ],
      },
      {
        title:
          "How planning, execution, QA, and finance stay aligned end to end",
        paragraphs: [
          "Healthy manufacturing ERP aligns four clocks: demand and supply planning time horizons, finite capacity on constrained resources on the shop floor, financial period close rhythms, and quality hold or release timelines. When those clocks drift—for example procurement optimises landed cost while production optimises uptime—inventory balloons, shortages surprise leadership, or margin explains itself only after spreadsheets reconcile the month.",
          "Material Requirement Planning connects demand to dependent requirements and highlights what must arrive before the line starts. Scheduling—whether finite or rough-cut depending on maturity—anchors promises to plausible capacity rather than optimism. Quality Management embeds dispositioning in the transactional flow so good product does not silently ship alongside non-conforming material waiting for paperwork.",
          "Costing stitches it together: BOM and routing drive standards, confirmations and scrap postings drive actuals, and variance narratives become weekly leadership signals—not quarterly archaeology. Reporting should answer “which orders, batches, shifts, machines, vendors, customers, SKUs skewed margins” rather than stating that margin moved without cause.",
        ],
      },
      {
        title: "A phased rollout pattern that avoids freezing the plant",
        paragraphs: [
          "Manufacturing transformations fail when ERP teams treat go-live like a theatrical launch instead of progressively hardening transactional truth. Practical programmes sequence scope so each phase earns adoption before the plant absorbs another layer of behavioural change.",
          "A workable pattern for many discrete and hybrid plants is (1) item master hygiene with controlled engineering change, BOM, and substitution discipline, plus warehouse correctness for critical components, then (2) purchase-to-receipt loops with disciplined goods receipt posting and landed cost allocations, followed by (3) production order execution with confirmations, downtime capture, labour or machine postings at the right granularity—without boiling the ocean—and (4) quality holds, non-conformance, and CAPA attached to receipts and confirmations so regulatory and customer evidence is native to operations rather than paralegal.",
          "Only after transactional consistency holds should leadership expand advanced scenarios such as APS with constraint modelling, subcontract or tolling choreography, barcode or kiosk capture at each operation, predictive maintenance signals, demand-driven refinement, multi-plant netting, global inventory visibility—or complex product configuration workflows. Trying to optimise before stabilising transactional truth collapses goodwill with shop supervision and procurement.",
        ],
        bullets: [
          "Single source of truth for items, BOM revisions, phantom assemblies, substitutes, shelf life—before scaling volume.",
          "Receipt and issue discipline before trusting inventory signals for MRP and promising customer dates.",
          "Shop-floor confirmations at the fidelity that finance and traceability genuinely require—not the fidelity a slide deck fantasises about.",
          "Executive dashboards gated on postings that reconcile to GL and inventory—not partial extracts that disagree by Monday morning.",
        ],
      },
      {
        title:
          "Integrations and plant data architecture that quietly decide success",
        paragraphs: [
          "ERP rarely stands alone at the velocity modern plants operate. Typical integration surfaces include MES or historians for telemetry, PLC or SCADA handoffs executed through gateways, barcode or kiosk capture on lines, TMS or freight partners, customer or supplier portals, tax or e-invoice rails, budgeting or consolidation tools, forecasting engines, aftermarket service systems, configurators feeding engineering and sales, laboratories or regulatory reporting platforms, payroll and time capture, procurement marketplaces—and sometimes regional compliance exchanges.",
          "Architecturally, integrations should converge on deterministic identifiers (items, warehouses, batches, orders, confirmations) rather than brittle string matching across silos that breaks under engineering changes. Event replay, idempotent posting, alerting on integration failures—not silent drops—and operational ownership for exception queues differentiate programmes that tolerate volume from programmes that degrade into manual bridges within a quarter.",
        ],
      },
      {
        title: "How Baaz approaches manufacturing ERP engagements",
        paragraphs: [
          "We prioritise blueprinting real flows before template demos: inbound material logic, BOM explosion quirks, substitutions, rework, yield, tooling constraints, QA holds, subcontract steps, costing policies, integrations, statutory reporting quirks, governance for engineering change, RACI across operations and finance—not generic feature checklists divorced from throughput.",
          "We deliver in phases aligned to transactional integrity and supervisor trust, instrumentation on variance and SLA indicators, rehearsals for migrations and integrations, stakeholder training keyed to behavioural change—not generic click training—and executive visibility that survives month-end—not vanity dashboards drifting from postings.",
          "If manufacturing ERP initiatives on your roadmap keep stalling beneath forecast accuracy, unexplained variance, unreliable promising, quality evidence gaps, brittle integrations, adoption collapse on the shop floor, or spreadsheets reconciling ERP nightly, a structured blueprint and phased programme usually surfaces which constraint is causal—before another expensive redo.",
        ],
      },
    ],
    challenges: [
    ...
    keyModules: [
      {
        ...
        description:
          "MRP, scheduling, capacity planning, work order management",
      },
      {
        name: "Inventory & Warehouse",
        description: "Stock tracking, bin management, reorder automation",
      },
      {
        name: "Procurement",
        description: "Supplier management, PO automation, goods receipt",
      },
      {
        name: "Quality Assurance",
        description: "Inspection, CAPA, non-conformance, certifications",
      },
      {
        name: "Finance & Costing",
        description: "Standard costing, variance analysis, GL integration",
      },
      {
        name: "Maintenance (CMMS)",
        description: "Preventive maintenance scheduling, downtime tracking",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Demand-driven procurement and accurate MRP eliminate over-stocking.",
      },
      {
        title: "30% Fewer Production Delays",
        description:
          "Integrated planning and shop-floor visibility reduce schedule disruptions.",
      },
      {
        title: "Accurate Product Costing",
        description:
          "Real-time cost tracking enables better pricing decisions and margin protection.",
      },
      {
        title: "Improved First-Pass Quality",
        description:
          "Systematic quality checks reduce scrap rates and customer returns.",
      },
    ],
    useCases: [
      {
  ...
  "banking-companies": buildErpPage({
    ...
    metaTitle:
      "Banking ERP — Procurement, GL Controls & Regulatory Reporting | Baaz",
    metaDescription:
      "Banking and financial institution ERP: branch governance, procure-to-pay, inter-branch reconciliation, fixed assets, HR, and regulatory reporting with full audit trails. Implementation and integration support from Baaz, Bangalore.",
    heroSubtitle:
    ...
    keyModules: [
      {
        name: "General Ledger",
        description: "Multi-entity GL, auto-posting, period close management",
      },
      {
        name: "Accounts Payable/Receivable",
        description: "Invoice processing, payment runs, ageing reports",
      },
      {
        name: "Procurement & Contracts",
        description: "Vendor lifecycle, PO management, contract compliance",
      },
      {
        name: "Fixed Assets",
        description: "Asset tracking, depreciation, disposal, audit reporting",
      },
      {
        name: "HR & Administration",
        description: "Employee management, payroll, leave, branch staffing",
      },
      {
  ...
  "healthcare-companies": buildErpPage({
    ...
    metaTitle: "Healthcare ERP — Supply Chain, Finance, HR & Compliance | Baaz",
    metaDescription:
      "ERP and EHR-aligned platform for healthcare organisations—finance, supply chain, HR, compliance—plus AI-native revenue cycle features: insurance capture, coding assistance, denial prevention, forecasting, and intelligent A/R. Plan and build with Baaz.",
    heroSubtitle:
    ...
    keyModules: [
      ...
      },
      {
        ...
        description: "GL, AP/AR, department budgets, revenue cycle support",
      },
      {
        name: "Inventory Management",
        description: "Lot tracking, expiry management, auto-replenishment",
      },
      {
        name: "HR & Workforce",
        description: "Credentialing, shift rosters, payroll, training records",
      },
      {
    ...
    caseStudyLink: {
      ...
      label: "Patient engagement app (case study)",
      description:
    ...
    aiEhrSection: HEALTHCARE_AI_EHR_SECTION,
  }),
  ...
  hospitals: buildErpPage({
    ...
    metaTitle:
      "Hospital ERP — Pharmacy, Procurement, Finance & Workforce | Baaz",
    metaDescription:
      "Hospital and multi-site ERP: pharmacy and consumable automation, procurement, cost-centre finance, shift and credential management, maintenance, and group reporting. Phased implementation with Baaz for hospital groups.",
    heroSubtitle:
    ...
    keyModules: [
      {
        ...
        description:
          "Drug inventory, batch tracking, auto-replenishment, expiry management",
      },
      {
        name: "Finance & Accounting",
        description: "GL, cost centres, AP/AR, department-level P&L",
      },
      {
        name: "Procurement",
        description:
          "Purchase requests, vendor management, contract compliance",
      },
      {
        name: "HR & Shift Management",
        description: "Rostering, payroll, attendance, credential tracking",
      },
      {
        name: "Facility Maintenance",
        description: "Work orders, preventive maintenance, asset tracking",
      },
      {
        name: "Reporting & Analytics",
        description: "Operational dashboards, KPI tracking, custom reports",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Automated reordering and consumption tracking ensure critical supplies are always available.",
      },
      {
        title: "20% Reduction in Admin Costs",
        description:
          "Unified systems eliminate duplicate data entry and manual report compilation.",
      },
      {
        title: "Accurate Department-Level Costing",
        description:
          "Cost centre tracking enables revenue-to-expense analysis by ward and service line.",
      },
      {
        title: "Improved Staff Satisfaction",
        description:
          "Fair, transparent shift scheduling with automated overtime and leave management.",
      },
    ],
    useCases: [
      {
    ...
    caseStudyLink: {
      href: "/healthcare-patient-app-case-study",
      label: "Patient app — bookings & care adjacency",
      description:
        "See a shipped React Native programme: appointments, clinical adjacency modules, documents, and device-ready release discipline.",
    },
  }),
  ...
  "real-estate-companies": buildErpPage({
    ...
    metaTitle:
      "Real Estate ERP — Projects, Leasing, Portfolio & Developer Finance | Baaz",
    metaDescription:
      "Real estate and property developer ERP: project budgeting and WIP, lease lifecycle and tenant billing, contractor procurement, portfolio dashboards, and owner reporting. Implementation partner Baaz.",
    heroSubtitle:
    ...
    keyModules: [
      {
        ...
        description: "Budgeting, cost tracking, WIP, change order management",
      },
      {
        name: "Lease Management",
        description: "Tenant records, lease terms, escalations, billing",
      },
      {
        name: "Procurement",
        description: "Material POs, contractor onboarding, invoice matching",
      },
      {
        name: "Accounts Receivable",
        description: "Rent invoicing, collection tracking, ageing analysis",
      },
      {
        name: "Fixed Assets",
        description: "Property records, depreciation, valuation tracking",
      },
      {
        name: "Reporting & BI",
        description:
  ...
  "construction-companies": buildErpPage({
    ...
    metaTitle:
      "Construction ERP — Site Costing, Subcontractors & Project Controls | Baaz",
    metaDescription:
      "Construction and EPC ERP: WBS budgets, site procurement and materials, subcontractor billing and retention, equipment, cash flow forecasting, and project financials. Implementation with Baaz.",
    heroSubtitle:
    ...
    keyModules: [
      {
        ...
        description: "WBS, scheduling, milestone tracking, resource allocation",
      },
      {
        name: "Procurement & Materials",
        description: "Material indent, PO, GRN, stock register, site transfers",
      },
      {
        name: "Subcontractor Management",
        description: "Contracts, work measurement, billing, retention",
      },
      {
  ...
  "automobile-companies": buildErpPage({
    ...
    metaTitle:
      "Automotive ERP — BOM, Quality, Supplier & Multi-Plant Planning | Baaz",
    metaDescription:
      "Automotive ERP for OEMs and suppliers: multi-level BOM and engineering change, MRP and scheduling, IATF-aligned quality and traceability, supplier collaboration, inter-plant logistics, and costing. Baaz implementation.",
    heroSubtitle:
    ...
    keyModules: [
      {
        name: "Production Planning",
        description: "MRP, capacity planning, production scheduling, kanban",
      },
      {
        name: "BOM & Engineering",
        description: "Multi-level BOMs, ECN management, revision tracking",
      },
      {
        name: "Supplier Management",
        description: "Vendor scorecards, schedule sharing, ASN, PPAP tracking",
      },
      {
      ...
      },
      {
        ...
        description: "WMS, inter-plant transfers, JIT delivery, packaging",
      },
      {
        name: "Finance & Costing",
        description:
  ...
  "transportation-supply-chain-companies": buildErpPage({
    ...
    metaTitle:
      "Logistics ERP — Fleet, WMS, Fulfilment & Freight Billing | Baaz",
    metaDescription:
      "Transportation and 3PL ERP: fleet and route operations, warehouse putaway-to-dispatch, order milestones, freight billing and reconciliation, procurement, and compliance documentation. Implement with Baaz.",
    heroSubtitle:
    ...
    keyModules: [
      {
        ...
        description:
          "Vehicle records, route assignment, GPS tracking, fuel logs",
      },
      {
        name: "Warehouse Management",
        description: "Inventory, putaway, picking, packing, dispatch",
      },
      {
        name: "Order Management",
        description:
          "Order intake, allocation, status tracking, customer notifications",
      },
      {
        name: "Finance & Billing",
        description:
          "Freight billing, AP/AR, cost allocation, revenue recognition",
      },
      {
        name: "Procurement",
        description: "Fuel procurement, spare parts, vendor management",
      },
      {
        name: "Compliance & Documentation",
        description:
          "Permits, fitness certificates, driver licenses, insurance",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Route optimisation, fuel tracking, and preventive maintenance reduce per-km costs.",
      },
      {
        title: "99% Order Visibility",
        description:
          "Real-time tracking and milestone updates for every shipment from pickup to delivery.",
      },
      {
        title: "Faster Warehouse Throughput",
        description:
          "Integrated WMS workflows reduce pick errors and accelerate order fulfilment.",
      },
      {
        title: "Regulatory Compliance Assurance",
        description:
          "Automated tracking of permits, certificates, and driver documentation prevents lapses.",
      },
    ],
    useCases: [
      {
  ...
  "education-training-companies": buildErpPage({
    slug: "education-training-companies",
    title: "ERP for Education & Training Companies",
    metaTitle:
      "Education & Training ERP — Cohorts, Fees, CRM & Delivery | Baaz",
    metaDescription:
      "ERP-style operations for institutes and training providers: batches and cohorts, attendance and homework workflows, scoped CRM, fees and access control, workshops, and leadership dashboards. Built with Baaz.",
    heroSubtitle:
      "Cohort and programme management, fee collection, attendance, CRM handoffs, and executive visibility for coaching institutes, academies, and corporate training providers.",
    challenges: [
      {
        title: "Fragmented Cohort Data",
        description:
          "Batches, workshops, and fee schedules live in spreadsheets and chat—making reconciliation and forecasting unreliable.",
      },
      {
        title: "CRM Without Boundaries",
        description:
          "Coaches and sales teams lack scoped views of their cohorts; leadership cannot see pipeline and delivery health in one place.",
      },
      {
        title: "Attendance & Completion Gaps",
        description:
          "Manual attendance capture and ad hoc homework distribution make it hard to prove completion or intervene early.",
      },
      {
        title: "Revenue Leakage & Access Drift",
        description:
          "Partial payments, refunds, and content access are managed informally—creating disputes and audit risk.",
      },
    ],
    solutionFeatures: [
      {
        title: "Programme & Batch Orchestration",
        description:
          "Course, batch, and calendar management with roster views, attendance capture, and workshop-style programmes where needed.",
      },
      {
        title: "Scoped CRM & Support",
        description:
          "Role-based CRM for institute, batch, and participant interactions—tickets, messaging, and homework in governed workflows.",
      },
      {
        title: "Fee & Access Alignment",
        description:
          "Payment schedules, overdue visibility, and approval-based access so content unlocks match financial truth.",
      },
      {
        title: "Executive & Compliance Dashboards",
        description:
          "Cohort health, revenue recognition signals, and operational KPIs without exporting five spreadsheets.",
      },
    ],
    keyModules: [
      {
        name: "Programme Management",
        description: "Courses, batches, calendars, rosters",
      },
      {
        name: "Attendance & Delivery",
        description: "Sessions, homework, materials, video requests",
      },
      { name: "CRM & Helpdesk", description: "Tiered CRM, tickets, messaging" },
      {
        name: "Finance & Payments",
        description: "Fees, partials, refunds, bank masters",
      },
      {
        name: "Workshops & Events",
        description: "Short programmes, barcodes, attendance exports",
      },
      {
        name: "Reporting & Analytics",
        description: "Cohort, revenue, and operational roll-ups",
      },
    ],
    benefits: [
      {
        title: "Single Operational Spine",
        description:
          "One system of record for cohorts, workshops, and participant journeys.",
      },
      {
        title: "Faster Month-End",
        description:
          "Structured payments and access reduce finance firefighting and informal overrides.",
      },
      {
        title: "Better Coach Productivity",
        description:
          "Scoped lists and homework tools keep CRM teams focused on their batches.",
      },
      {
        title: "Leadership Visibility",
        description:
          "Dashboards tie enrolment, attendance, and cash signals for better decisions.",
      },
    ],
    useCases: [
      {
        title: "Enrolment-to-Completion Lifecycle",
        description:
          "Lead capture → batch assignment → attendance and homework → certification or next programme—without duplicate entry.",
      },
      {
        title: "Workshop & Event Operations",
        description:
          "Short programmes with registration, barcode check-in, attendance exports, and participant reconciliation.",
      },
      {
        title: "Finance & Access Reconciliation",
        description:
          "Scheduled fees, partials, refunds, and approval queues so learning access matches payment reality.",
      },
    ],
    relatedServices: [
      { slug: "product-strategy", label: "Product Strategy" },
    ...
    caseStudyLink: {
      ...
      label: "Training operations portal (case study)",
      description:
        "See a shipped React portal: multi-role CRM, workshops with barcodes, payments, homework, and participant UX—aligned to institute operations.",
    },
  }),
};
