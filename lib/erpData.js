...
export const erpData = {
  ...
  "manufacturing-companies": buildErpPage({
    ...
    metaTitle:
      "Custom ERP for Manufacturing | MRP, Shop Floor & Costing | Baaz",
    metaDescription:
      "Custom ERP for manufacturing—MRP, BOM, shop-floor execution, QA, costing, and integrations for global manufacturing operations. Discrete and hybrid ERP software development with phased rollout from Baaz.",
    heroSubtitle:
  ...
  "banking-companies": buildErpPage({
    ...
    metaDescription:
      "Banking and financial institution ERP: branch governance, procure-to-pay, inter-branch reconciliation, fixed assets, HR, and regulatory reporting with full audit trails. Implementation and integration support for banks worldwide from Baaz.",
    heroSubtitle:
  ...
  "healthcare-companies": buildErpPage({
    ...
    metaTitle:
      "Healthcare ERP Software Development & Implementation | Baaz",
    metaDescription:
      "Healthcare ERP software development—finance, supply chain, HR, compliance, integrations—aligned with clinical and revenue workflows. Baaz architects phased programmes for hospitals and health networks worldwide.",
    heroSubtitle:
  ...
  "real-estate-companies": buildErpPage({
    ...
    metaTitle:
      "ERP for Real Estate Companies | Developer & Portfolio | Baaz",
    metaDescription:
      "ERP for real estate developers and portfolio managers—project budgeting, WIP, leasing, tenant billing, procurement, dashboards. Custom ERP programmes and rollout support for global portfolios.",
    heroSubtitle:
  ...
  "construction-companies": buildErpPage({
    ...
    metaTitle:
      "ERP for Construction Companies | WBS & Site Costing | Baaz",
    metaDescription:
      "ERP for construction and EPC—WBS, materials, subcontractors, retention, billing, cash flow, and controls. ERP software development and implementation guidance for contractors worldwide from Baaz.",
    heroSubtitle:
