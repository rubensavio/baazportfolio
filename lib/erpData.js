...
export const erpData = {
  ...
  "education-training-companies": buildErpPage({
    ...
    keyModules: [
      { name: "Programme Management", description: "Courses, batches, calendars, rosters" },
      { name: "Attendance & Delivery", description: "Sessions, homework, materials, video requests" },
      { name: "CRM & Helpdesk", description: "Tiered CRM, tickets, messaging" },
      { name: "Finance & Payments", description: "Fees, partials, refunds, bank masters" },
      { name: "Workshops & Events", description: "Short programmes, barcodes, attendance exports" },
      { name: "Reporting & Analytics", description: "Cohort, revenue, and operational roll-ups" },
    ],
    benefits: [
      {
        title: "Single Operational Spine",
        description: "One system of record for cohorts, workshops, and participant journeys.",
      },
      {
        title: "Faster Month-End",
        description: "Structured payments and access reduce finance firefighting and informal overrides.",
      },
      {
        title: "Better Coach Productivity",
        description: "Scoped lists and homework tools keep CRM teams focused on their batches.",
      },
      {
        title: "Leadership Visibility",
        description: "Dashboards tie enrolment, attendance, and cash signals for better decisions.",
      },
    ],
    useCases: [
      {
