/** Shared FAQ copy for /project-rescue — used by page UI and layout JSON-LD. */
export const rescueFaqs = [
  {
    question: "What is software project rescue?",
    answer:
      "Software project rescue is when a new engineering partner takes over a stalled, delayed, or mismanaged software build from a prior vendor or internal team—usually after a codebase audit, stabilization of deployments and critical defects, and continued feature delivery—without defaulting to a full rewrite when working code can be preserved. Baaz specializes in mid-project takeovers for teams worldwide; over 50% of Baaz engagements begin as rescues per Baaz's internal project classification.",
  },
  {
    question: "My software vendor is not delivering — what should I do?",
    answer:
  ...
  {
    question:
      "What if the audit reveals the project should be rebuilt from scratch?",
    answer:
  ...
  {
    question:
      "What technologies and frameworks do you work with for project rescue?",
    answer:
