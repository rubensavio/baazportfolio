...
export const HOME_WORK_ITEMS = [
  ...
  },
  {
    ...
    hook: "Defect escape rate to OEMs down 67% · OEE across 6 plants up 71% → 86% · traceability audit time: 3 days → 2 hours",
  ...
  },
  {
    ...
    hook: "Sample rejection rate 3.8% → 0.6% · result TAT improved 32% · 1.8M patient app downloads in 12 months",
  ...
  },
  {
    ...
    hook: "Fleet utilisation 68% → 84% · SLA compliance 88% → 97% · client NPS 71 → 86",
