  ...
  stories: [
    {
      ...
      result:
        "Tyre-related breakdowns reduced 58% for enrolled fleets; tyre replacement cost savings avg €3,200/truck/year; fuel efficiency improved 4.1% via optimal pressure maintenance; fleet manager NPS 81",
    },
    {
      industry: "Financial Services",
      client: "Leading global financial services firm",
      result:
        "Fraud detection rate improved 85%; false-positive rate reduced to 0.4%; AML case resolution time down 58%; regulatory audit findings reduced to zero in monitored segments.",
    },
    {
      industry: "Retail",
      client: "Europe's retail major",
      result:
        "Personalised coupon redemption 3.6× higher vs broadcast; incremental revenue per loyalty household up $54/year; promotional ROI improved 31%; churn in targeted segments reduced 17%.",
    },
    {
      industry: "Healthcare",
      client: "Global healthcare network",
      result:
        "Theatre utilisation improved from 69% to 87%; elective surgery cancellation rate reduced from 6.2% to 1.1%; scheduling coordinator time per week reduced 14 hours; patient surgical wait time reduced 28%.",
    },
  ],
};
