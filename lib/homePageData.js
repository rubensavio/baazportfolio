...
export const HOME_SERVICES = [
  ...
  },
  {
    ...
    href: "/technologies/llm-fine-tuning",
    children: [{ label: "AI/ML Models", href: "/technologies/ai-ml-models" }],
    description:
      "Fine-tune open-weight models on your own data so a small model you own matches frontier quality on your task, at a fraction of the inference cost. LoRA and QLoRA adapters, preference tuning, distillation, and the evaluation harness that proves it worked.",
  },
  {
    num: "03",
...
export const HOME_WORK_ITEMS = [
  {
    num: "01",
    client: "Federal Bank Ltd",
    industry: "BFSI / NRI Banking",
    title: "Unified NRI Digital Remittance & Investment Platform",
    hook: "Instant remittance across UAE, USA, UK & Bahrain · NRI FDs and PIS investing made self-service · Multilingual in Malayalam, Hindi & English",
    href: "/case-studies/nri-digital-banking-platform",
  },
  {
    num: "02",
    client: "Leading Retailer from India",
    industry: "eCommerce / Retail",
    title: "Turning Browsing Into Gifting: An AI-Powered Omnichannel Storefront",
    hook: "AI gifting engine drives 29% of D2C GMV in 8 months · gifting AOV 2.3× standard browsing · inventory accuracy 78% → 96% · repeat purchase 14% → 27%",
    href: "/case-studies/omnichannel-d2c-gifting-engine",
  },
  {
    num: "03",
    client: "Minda Industries",
    industry: "Manufacturing / Industrial IoT",
    title: "From Shop Floor to OEM: A Smart Factory IoT & Quality Traceability Platform",
    hook: "Defect escape rate to OEMs down 67% · first-pass yield 93.1% → 98.4% · OEE across 6 plants 71% → 86% · traceability audit: 3 days → 2 hours",
    href: "/case-studies/smart-factory-iot-traceability",
  },
  {
    num: "04",
    client: "Healius Ltd",
    industry: "Healthcare / Diagnostics",
    title: "From Sample to Result to Patient: A Connected Pathology Network ERP",
    hook: "Sample rejection rate 3.8% → 0.6% · result TAT improved 32% · 1.8M patient app downloads · billing error rate 4.2% → 0.3%",
    href: "/case-studies/pathology-lab-erp-patient-app",
  },
  {
    num: "05",
    client: "Leading Corporate Mobility Provider from India",
    industry: "Travel & Tourism / Corporate Mobility",
    title: "Smarter Dispatch, Stronger SLAs: An AI Fleet Optimisation Platform",
    hook: "Driver idle time down 29% · fleet utilisation 68% → 84% · SLA compliance 88% → 97% · client NPS 71 → 86",
    href: "/case-studies/corporate-mobility-crm-dispatch",
  },
];
...
export const HOME_HERO = {
  headline: "The world's software factory, with a <strong>taste</strong>.",
  sub: "Baaz has been consulting and shipping production-grade software solutions for enterprises across 26+ countries since 2018 that moves billions of dollars in value every day.",
...
export const HOME_WHY_BAAZ = {
  ...
  reasons: [
    ...
    },
    {
      ...
      title: "Speed",
      paragraphs: [
        "We deliver 40% faster than traditional timelines. Not by cutting corners, but by having done this again and again.",
...
export const HOME_CTA = {
  ...
  leftLines: [
    ...
    "We'll tell you how fast we can ship it and what it'll cost to you.",
  ],
  contact: {
    title: "Get in touch!",
    addresses: [
