...
export const HOME_HERO = {
  headline:
    "Anyone can ship softwares now. Few ship it with a <strong>taste</strong>.",
  sub: "Baaz is the engineering partner enterprises bring in when the build actually has to work.",
