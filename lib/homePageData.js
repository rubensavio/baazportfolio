...
export const HOME_STATS_HERO = [
  { value: "$2", suffix: " Billion", label: "Value of business generated for customers", suffixClass: "stat-suffix-sm" },
  { value: "$150", suffix: " Million", label: "Saved in annual losses & costs for customers", suffixClass: "stat-suffix-sm" },
  { value: "26", suffix: "+", label: "Countries served" },
];

export const HOME_STATS_DEEP = [
  { value: "40", suffix: "%", label: "Faster than traditional software delivery timelines" },
...
export const HOME_HERO = {
  headline: "In today’s hyper evolving world of AI, building software is no longer a novelty, but building it with a <strong>taste</strong> is<strong>.</strong>",
  ...
  ctas: [
    { label: "Book a 30-min call", href: CALENDAR_URL, style: "primary" },
    { label: "Get in touch", href: "/get-in-touch", style: "outline" },
  ],
  ctaNote: "30 minutes with the founder. No sales layer, no obligation.",
...
export const HOME_TECH_DEPTH = {
  ...
  categories: [
    ...
    },
    {
      ...
      items:
        "Pinecone, FAISS, Weaviate, TensorFlow, PyTorch, NumPy / Pandas",
    },
    {
      title: "Databases",
  ...
  stories: [
    {
      ...
      headline: { value: "58%", label: "reduction in tyre-related breakdowns across enrolled fleets" },
      metrics: [
        { value: "€3,200", label: "avg tyre replacement savings per truck, per year" },
        { value: "4.1%", label: "fuel efficiency gained via optimal pressure maintenance" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { value: "Zero", label: "regulatory audit findings in monitored segments" },
      ],
    },
    {
      industry: "Retail",
      client: "Europe's retail major",
      headline: { value: "3.6×", label: "higher coupon redemption with personalisation vs broadcast" },
      metrics: [
        { value: "$54", label: "incremental revenue per loyalty household, per year" },
    ...
    },
    {
      ...
      metrics: [
        { value: "1.1%", label: "elective surgery cancellation rate, down from 6.2%" },
        { value: "14 hrs", label: "scheduling coordinator time saved per week" },
...
export const HOME_CTA = {
  ...
  contact: {
    title: "Get in touch!",
    addresses: [
      { label: "India", text: "WeWork, RMZ Latitude, Bellary Road, Hebbal, Bengaluru 560024" },
      { label: "US", text: "30 N Gould St Ste R, Sheridan, Sheridan County, WY 82801" },
    ],
    phone: "+91-9986255177",
