...
export const WORK1_CASE_STUDY_FAQ_ITEMS = [
  ...
  {
    question: "How do you integrate AI quality signals with existing QA and rework processes?",
    answer:
  ...
  {
    question: "What should leadership expect when rolling out AI inspection in production?",
    answer:
