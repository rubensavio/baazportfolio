...
export const VISION_INTELLIGENCE_CASE_STUDY = {
  ...
  summary:
    "Robotics and foundation-model teams don't fail on algorithms - they fail on data. So we built Payana (payana.ai), our managed data-annotation service: an end-to-end pipeline that captures real-world tasks from a wearable camera and auto-generates structured, labeled, human-verified datasets in every major training format.",
  ...
  overview:
    "Robotics and foundation-model teams are bottlenecked by data: real-world demonstrations are expensive to capture and even harder to label consistently. This platform closes that gap with an end-to-end pipeline. A worker wears a camera and performs a task; computer vision automatically understands every moment - extracting actions, objects, and context frame by frame - and turns it into reviewable, version-controlled datasets. What synthetic data cannot replicate, we capture from real human activity. We deliver this as Payana (payana.ai), our managed data-annotation service.",
  datasets: [
    {
      slug: "plant-disease",
      video: "/assets/video-annotation/Plants.mp4",
      poster: "/assets/video-annotation/plants.png",
      title: "Plants",
      caption: "Fine-grained plant & foliage segmentation",
      playbackRate: 5,
    },
    {
      slug: "traffic",
      image: "/assets/video-annotation/multiobject.png",
      title: "Traffic",
      caption: "Multi-object road-scene detection & tracking",
    },
    {
      slug: "medical-xray",
      video: "/assets/video-annotation/X-ray-medical.mp4",
      poster: "/assets/video-annotation/x-ray-medical.png",
      title: "Medical X-Ray",
      caption: "Clinical X-ray annotation for medical AI",
      playbackRate: 10,
    },
    {
      slug: "sports",
      video: "/assets/video-annotation/Sports.mp4",
      title: "Sports",
      caption: "Athlete & motion tracking in sports footage",
      playbackRate: 1,
    },
  ],
  metrics: [
