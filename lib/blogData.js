...
export const blogData = {
  ...
  "best-software-development-agencies-for-startups": {
    ...
    metaDescription:
      "What to look for in a startup software agency: speed, product thinking, transparency, fit. Red flags, green flags, criteria from Baaz—since 2018.",
  ...
  "how-to-choose-software-development-partner": {
    ...
    metaDescription:
      "How to choose a software development partner: define scope, questions to ask, culture fit, mistakes to avoid—practical guide from Baaz product engineering team.",
  ...
  "how-to-build-ai-powered-product": {
    ...
    metaDescription:
      "Build an AI product the right way: problem first, tight pilot, data and deployment, then iterate. CV, NLP, production ML from Baaz, Bangalore since 2018.",
  ...
  "software-development-outsourcing-vs-in-house": {
    ...
    metaDescription:
      "Outsourcing vs in-house software: when each wins, hybrid models, risks, picking a partner. Trade-offs from Baaz—product engineering, not staff aug.",
  ...
  "product-engineering-process-for-enterprises": {
    ...
    metaDescription:
      "Enterprise product engineering: discovery, design, agile build, UAT, staged rollout—with governance. How Baaz delivers for large organizations.",
  ...
  "signs-your-software-project-is-failing": {
    ...
    metaDescription:
      "Is your software project failing? Slipped deadlines, churn, vague demos—what to do next. When rescue beats rebuild; from Baaz (50%+ rescues).",
  ...
  "how-to-switch-software-development-vendors": {
    ...
    metaDescription:
      "Switch dev vendors mid-project: secure repos and keys, audit the codebase, pick a takeover-ready partner, then audit→stabilize→ship. Baaz project rescue.",
  ...
  "software-project-rescue-checklist": {
    ...
    metaDescription:
      "Rescue checklist: secure assets, fast audit, stabilize CI/CD and prod, cut debt, resume sprints. Playbook from Baaz—most work is mid-project rescue.",
  ...
  "reference-architecture-b2b-saas": {
    ...
    metaTitle: "B2B SaaS Reference Architecture: APIs & Data | Baaz",
    metaDescription:
      "B2B SaaS architecture: boundaries, sync vs async, tenancy, identity, data stores, top failure modes—practical baseline for product teams from Baaz.",
    title:
  ...
  "slos-error-budgets-reliability": {
    ...
    contentType: "Architecture guide",
    metaTitle: "SLOs, Error Budgets & Reliability: Practical Guide | Baaz",
    metaDescription:
      "SLIs and SLOs, error budgets, burn-based alerting—latency vs availability, aligning product and reliability. Practical SRE-style guide from Baaz.",
  ...
  "reliable-data-integration-events-cdc-outbox": {
    ...
    metaDescription:
      "Events vs outbox vs CDC: when each fits, dual-write risks, idempotency, ordering, ops checklist for SaaS integrations—architecture notes from Baaz.",
    title:
