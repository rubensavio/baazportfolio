...
import { howToEstimateApiIntegrationWorkPost } from "./blogPosts/how-to-estimate-api-integration-work.js";
import { whatIsSemanticSegmentationPost } from "./blogPosts/what-is-semantic-segmentation.js";
import { howToChooseDatasetFormatPost } from "./blogPosts/how-to-choose-dataset-format.js";
import { automatedDataLabelingPost } from "./blogPosts/automated-data-labeling.js";
import { beamMemoryBenchmarkPost } from "./blogPosts/beam-memory-benchmark-for-ai-agents.js";
import { temporalReasoningSuprfloPost } from "./blogPosts/introducing-temporal-reasoning-in-suprflo.js";
import { useOfAiInComputerVisionPost } from "./blogPosts/use-of-ai-in-computer-vision.js";
import { biTemporalMemoryArchitecturePost } from "./blogPosts/why-ai-agents-need-bi-temporal-memory-architecture.js";

export const blogData = {
  "why-ai-agents-need-bi-temporal-memory-architecture":
    biTemporalMemoryArchitecturePost,
  "use-of-ai-in-computer-vision": useOfAiInComputerVisionPost,
  "introducing-temporal-reasoning-in-suprflo": temporalReasoningSuprfloPost,
  "beam-memory-benchmark-for-ai-agents": beamMemoryBenchmarkPost,
  "automated-data-labeling": automatedDataLabelingPost,
  "how-to-choose-dataset-format": howToChooseDatasetFormatPost,
  "what-is-semantic-segmentation": whatIsSemanticSegmentationPost,
  ...
  "how-to-estimate-api-integration-work": howToEstimateApiIntegrationWorkPost,
  "best-software-development-agencies-for-startups": {
    ...
    metaDescription:
      "Pick a startup software agency: speed, product thinking, transparency & fit-red flags, green flags & criteria that matter. Baaz since 2018.",
    ...
    sections: [
      ...
      {
        heading: "How Should You Shortlist and Compare Agencies Fairly?",
        body: [
          ...
          "Score proposals on a simple matrix: relevant experience, team seniority, process clarity, quality practices (tests, CI/CD, code review), communication model, and post-launch support. Hide pricing until you score qualitatively-otherwise cheap-but-risky options anchor the conversation. Use the scoring lens below when comparing written proposals.",
        ...
        table: {
          caption:
            "Startup agency evaluation - what to score before you compare price",
          headers: ["Criterion", "What strong signals look like", "What should worry you"],
          rows: [
            [
              "Relevant delivery",
              "Case studies at your stage - references from ambiguous products, not only polished launches",
              "Only enterprise logos when you need a fast MVP - no named engineers for early sprints",
            ],
            [
              "Team & access",
              "Named roles for the first two sprints - repo and environment access from week one",
              "Rotating bench - account manager as the only interface to engineering",
            ],
            [
              "Quality & ops",
              "Tests, CI/CD, code review - incident and support story after launch",
              "Launch treated as handoff - no monitoring or dependency update story",
            ],
            [
              "Commercials & change",
              "Clear change-control - phased quotes tied to demoable milestones",
              "Fixed huge scope with no discovery buffer - vague change pricing",
            ],
          ],
        },
        references: [
          {
            label: "OWASP SAMM - Software assurance maturity model (vendor security posture)",
            href: "https://owaspsamm.org/",
          },
          {
            label: "ISO/IEC 27001 - Information security management systems overview",
  ...
  "how-to-choose-software-development-partner": {
    ...
    metaDescription:
      "Choose a software dev partner: scope, questions to ask, culture fit & mistakes to avoid-practical shortlisting guide from Baaz since 2018.",
    ...
    relatedLinks: [
      {
        ...
        label: "Custom software & recovery delivery",
      },
    ],
    faqs: [
      {
  ...
  "software-project-rescue-checklist": {
    ...
    sections: [
      {
        heading: "What Does the Software Project Rescue Timeline Look Like?",
        body: [
        ...
        table: {
          caption: "Rescue phases at a glance (typical sequencing)",
          headers: ["Phase", "Timing", "Primary goal", "Common failure if skipped"],
          rows: [
            [
              "1 - Secure & assess",
              "Days 1–3",
              "Repositories, infra, facts-not opinions - architecture and risk map",
              "Building on wrong assumptions about what is deployed",
            ],
            [
              "2 - Stabilize",
              "Weeks 1–3",
              "CI/CD, production defects, security patches, basic tests on critical paths",
              "New features on unstable foundation - compounding incidents",
            ],
            [
              "3 - Debt & delivery",
              "Weeks 4+",
              "Refactor what blocks progress - predictable sprints and demos",
              "Polishing code while users cannot get a reliable release",
            ],
          ],
        },
        references: [
          {
            label: "DORA - Metrics that matter for software delivery performance",
            href: "https://dora.dev/research/",
          },
          {
            label: "Google SRE - Books & reliability practices (release discipline)",
