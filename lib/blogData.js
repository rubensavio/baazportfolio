...
export const blogData = {
  ...
  "best-software-development-agencies-for-startups": {
    ...
    metaDescription:
      "How to pick a startup software agency: speed, product thinking, transparency, and fit—red flags, green flags, and criteria that actually matter. From Baaz, Bangalore since 2018.",
  ...
  "how-to-choose-software-development-partner": {
    ...
    metaDescription:
      "How to choose a software development partner: define scope, questions to ask, culture fit, and mistakes to avoid—practical guide from Baaz. Book a call when you are ready to shortlist.",
  ...
  "how-to-build-ai-powered-product": {
    ...
    metaDescription:
      "Build an AI product the right way: start with the problem, run a tight pilot, validate data and deployment, then iterate. CV, NLP, and production ML notes from Baaz since 2018.",
  ...
  "software-development-outsourcing-vs-in-house": {
    ...
    metaDescription:
      "Software outsourcing vs in-house: when each wins, hybrid models, risks, and how to pick a partner—trade-offs from Baaz product engineering (not staff aug). Bangalore since 2018.",
  ...
  "product-engineering-process-for-enterprises": {
    ...
    metaDescription:
      "Enterprise product engineering process: discovery, design, agile build, UAT, and staged rollout with governance—how Baaz delivers for large organizations without losing speed.",
  ...
  "signs-your-software-project-is-failing": {
    ...
    metaDescription:
      "Is your software project failing? Slipped deadlines, churn, vague demos—and what to do next. When rescue beats rebuild; over 50% of Baaz work is mid-project rescue.",
  ...
  "how-to-switch-software-development-vendors": {
    ...
    metaDescription:
      "Switch dev vendors mid-project: secure repos and keys, audit the codebase, pick a takeover-ready partner, then audit, stabilize, and ship again—playbook from Baaz project rescue.",
  ...
  "software-project-rescue-checklist": {
    ...
    metaDescription:
      "Software project rescue checklist: secure assets, fast audit, stabilize CI/CD and production, cut debt, resume sprints—playbook from Baaz; most engagements are mid-project takeover.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "\"Just add more developers\" without fixing build/deploy/test bottlenecks spreads confusion and slows everyone—Brooks's law still applies.",
  ...
  "reference-architecture-b2b-saas": {
    ...
    metaDescription:
      "B2B SaaS reference architecture: service boundaries, sync vs async, tenancy, identity, data stores, and top failure modes—practical baseline for product teams from Baaz engineering.",
    title:
  ...
  "slos-error-budgets-reliability": {
    ...
    metaDescription:
      "SLIs, SLOs, error budgets, and burn-based alerting—latency vs availability and aligning product with reliability. Practical SRE-style guide from Baaz for production teams.",
  ...
  "reliable-data-integration-events-cdc-outbox": {
    ...
    metaDescription:
      "Reliable data integration: events vs outbox vs CDC, dual-write risks, idempotency, ordering, and an ops checklist for SaaS—architecture notes from Baaz product engineering.",
    title:
