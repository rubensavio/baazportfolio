...
export const blogRelatedLinksBySlug = {
  "use-of-ai-in-computer-vision": [
    ...
    {
      href: "/blog/automated-data-labeling",
      label: "Automated data labeling pipelines",
    },
    { href: "/services/ai-solution", label: "AI & computer vision development" },
    { href: "/book-call", label: "Book a vision-intelligence call" },
  ],
  "why-ai-agents-need-bi-temporal-memory-architecture": [
    ...
    { href: "/book-call", label: "Book an AI engineering call" },
  ],
  "introducing-temporal-reasoning-in-suprflo": [
    { href: "/technologies/agentic-ai", label: "Agentic AI capabilities" },
    {
      href: "/technologies/ai-ml-models",
      label: "AI & ML models and integrations",
    },
    {
      href: "/blog/beam-memory-benchmark-for-ai-agents",
      label: "Why BEAM is a good memory benchmark",
  ...
  "beam-memory-benchmark-for-ai-agents": [
    { href: "/technologies/agentic-ai", label: "Agentic AI capabilities" },
    {
      href: "/technologies/ai-ml-models",
      label: "AI & ML models and integrations",
  ...
  "automated-data-labeling": [
    {
      ...
      label: "AI-assisted annotation (Payana)",
    },
    {
      href: "/blog/what-is-semantic-segmentation",
      label: "What is semantic segmentation?",
    },
    {
      ...
      label: "Choosing a dataset format",
    },
    { href: "/services/ai-solution", label: "AI & computer vision development" },
    { href: "/book-call", label: "Book a data pipeline call" },
  ],
  "how-to-choose-dataset-format": [
    {
      href: "/technologies/vision-intelligence/case-studies",
  ...
  "thoughtworks-alternatives": [
    ...
    },
    {
      ...
      label: "Choosing a development partner",
    },
  ...
  "technical-due-diligence-custom-software": [
    ...
    {
      href: "/blog/how-to-estimate-api-integration-work",
      label: "Estimate integration timelines",
    },
  ],
  "how-to-estimate-api-integration-work": [
    { href: "/services/web-development", label: "Custom software & integrations" },
    {
      href: "/technologies/devops-cloud",
      label: "Reliability, limits & production ops",
    },
    {
      href: "/blog/reliable-data-integration-events-cdc-outbox",
      label: "Reliable data integration patterns",
    },
    { href: "/blog/how-to-scope-mvp-that-ships", label: "Scoping MVPs that ship" },
    { href: "/get-in-touch", label: "Discuss an integration programme" },
  ],
  ...
  "product-engineering-process-for-enterprises": [
    ...
    {
      href: "/blog/how-to-estimate-api-integration-work",
      label: "Estimating API integration work",
    },
  ],
  ...
  "reliable-data-integration-events-cdc-outbox": [
    ...
    {
      href: "/blog/how-to-estimate-api-integration-work",
      label: "API integration estimation guide",
    },
    {
