...
export const ABOUT_FAQ_ITEMS = [
  {
    ...
    answer:
      `Baaz is a ${BRAND_POSITIONING_COMBINED}: custom software and product engineering for startups, scale-ups, and enterprises worldwide since 2018, also searchable as software company and IT services. Baaz has delivered 100+ applications across sectors such as eCommerce, FinTech, and retail; the portfolio count reflects Baaz's internal delivery records.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Baaz is headquartered in Bangalore (Bengaluru), Karnataka, India, and routinely collaborates with teams in other regions using remote-first rituals: shared boards, regular demos, and direct access to engineers on the build.",
  },
  {
