...
export const ABOUT_FAQ_ITEMS = [
  {
    ...
    answer:
      `Baaz is a ${BRAND_POSITIONING_COMBINED} ${BRAND_SCOPE_LINE}, serving product and engineering teams since 2018. Baaz has delivered 100+ applications across eCommerce, FinTech, and retail per its internal records.`,
  },
  {
