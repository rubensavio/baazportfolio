...
export const CONTACT_LEARN_MORE = {
  ...
  lede: "Same product engineering focus as the rest of the site—organized so you can skim, click through, or book time without hunting through long paragraphs.",
  cards: [
    {
      title: "Services & programs",
      text: "End-to-end delivery from discovery through launch: strategy, UX, engineering, mobile, and AI where it earns its place—plus rescue, enterprise, and go-to-market support when scope demands it.",
      links: [
    ...
    },
    {
      ...
      text: "Outcomes and craft across industries, plus how we think about building products. Start with case studies or work samples, then dig into longer writing on the blog.",
      links: [
