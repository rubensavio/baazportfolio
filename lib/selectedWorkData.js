...
export const selectedWorkData = {
  ...
  "smart-factory-iot-traceability": {
    ...
    metaTitle:
      "Smart Factory IoT & Quality Traceability Platform for Minda Industries - Case Study | Baaz",
    metaDescription:
  ...
  "pathology-lab-erp-patient-app": {
    ...
    metaTitle:
      "Connected Pathology Network ERP & Patient App for Healius - Case Study | Baaz",
    metaDescription:
  ...
  "corporate-mobility-crm-dispatch": {
    ...
    metaTitle:
      "AI Fleet Optimisation & Corporate Mobility CRM - Case Study | Baaz",
    metaDescription:
