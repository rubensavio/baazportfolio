export const technologyCapabilitiesData = {
  ...
  "llm-fine-tuning": {
    ...
    webServices: [
      ...
      {
        title: "The data cannot leave your servers",
        icon: "enterprise",
        description:
      ...
      {
        title: "The model has to stay put",
        icon: "web",
        description:
    ...
    engagement: {
      heading: "How an engagement is shaped",
      intro:
      ...
      note: "Engagements in between are common and scoped the same way. If your problem turns out not to need fine-tuning, the pilot is where we tell you.",
    },
    deployment: {
    ...
    faqs: [
      ...
      {
        question: "Can the model run on our own servers instead of the cloud?",
        answer:
      ...
      {
        question: "Does our training data stay private?",
        answer:
