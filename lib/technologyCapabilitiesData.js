export const technologyCapabilitiesData = {
  "web-development": {
    ...
    stackHeading: "Technologies We Use for Web Application Development",
    stackIntro:
      "At Baaz, we leverage modern web application technologies to deliver robust, scalable, and user-friendly solutions. Our team ensures best practices and modern frameworks are applied for high-quality outcomes.",
    stackGroups: [
      {
        title: "Frontend Development",
        description:
          "We use HTML5, CSS3, JavaScript, React, and Next.js to build responsive interfaces with strong usability and maintainable UI architecture.",
      },
      {
        title: "Backend Development",
        description:
          "We build secure backend systems with Node.js and Express.js, creating reliable APIs and scalable service layers for business-critical applications.",
      },
      {
        title: "Database & APIs",
        description:
          "We design database and API layers with GraphQL and integration-ready patterns to support secure data flow and scalable web platforms.",
      },
    ],
    stack: [
      "HTML5",
...
export const technologyCapabilitySlugs = Object.keys(technologyCapabilitiesData);
