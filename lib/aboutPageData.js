...
export const ABOUT_HERO = {
  statement: "Custom Software Development Company Since 2018.",
  stats: [
...
export const ABOUT_ORIGIN = {
  label: "Who We Are",
  quote: "8 Years. 3 Continents. One standard taste & speed.",
  paragraphs: [
...
export const ABOUT_CLOSING = {
  ...
  paragraphs: [
    "Tell us what you'd like to build. We'll tell you how fast we can ship it and what it'll cost to you.",
